            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="{{ route('my.order') }}" class="nav-link">Food Orders</a></li>
                        <li class="nav-item"><a href="{{ route('my.booking') }}" class="nav-link">Table Booking</a>
                        </li>
                        @guest
                            @if (Route::has('login'))
                            ...
                            <div class="block-21 mb-4 d-flex">
                                ...
                                <div class="text">
                                    <h3 class="heading"><a href="#">Even the all-powerful Pointing has no
                                            ...
                                            about</a></h3>
                                    <div class="meta">
                                        <div><a href="#"><span class="icon-calendar"></span> Sept 15, 2018</a>
                                        </div>
